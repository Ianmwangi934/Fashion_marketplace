...
const PaymentSuccess = () =>{
    ...
    useEffect(() =>{
        ...
        axios.post(`https://fashion-marketplace-12.onrender.com/store/order/shipped/${orderId}/`,{},{
            headers: {
        ...
        axios.get(`https://fashion-marketplace-12.onrender.com/store/order/${orderId}/`,{
            headers: {
                Authorization: `Bearer ${localStorage.getItem("access_token")}`
            }
        }).then(res =>{
